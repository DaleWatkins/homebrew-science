...
class Cppad < Formula
  ...
  url "http://www.coin-or.org/download/source/CppAD/cppad-20141219.epl.tgz"
  version "20141219"
  sha1 "b70bddcae1b67b30b2dcecef99759305fb7cd9c5"
  ...
  def install
    ...
    # On Mountain Lion, Clang does't find cstdint.h.
    cmake_args << "-Dcppad_cxx_flags=-stdlib=libc++" if ENV.compiler == :clang and (OS.mac? && MacOS.version <= :mountain_lion)
